...
import com.shopclues.pages.Addtocartpage;
import com.shopclues.pages.CartTestPage;
import com.shopclues.pages.CatogoryPage;
import com.shopclues.pages.HomePage;
import com.shopclues.pages.ProductList;
import com.shopclues.pages.ProductdetailsPage;
...
public class ShopCluesTest extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	public void stepsFlow() throws InterruptedException
	{
	    ...
	    QAFTestBase.pause(7000);                                          //pause statement
